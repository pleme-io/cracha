  ...
  internal = rec {
    ...
    crates = {
      ...
      "tower" = rec {
        ...
        resolvedDefaultFeatures = [ "balance" "buffer" "discover" "filter" "futures-core" "futures-util" "indexmap" "limit" "load" "log" "make" "pin-project-lite" "ready-cache" "slab" "sync_wrapper" "tokio" "tokio-util" "tracing" "util" ];
      };
      "tower-http" = rec {
